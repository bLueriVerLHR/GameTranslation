...
RUNTIME_SHIM_IIFE = "\n".join([
    ...
    "            else if (a === 'save') kag.menu.displaySave();",
    "            else if (a === 'load') kag.menu.displayLoad();",
    "            else if (a === 'log') kag.menu.displayLog();",
    "            else if (a === 'auto') kag.setAuto(!kag.stat.is_auto);",
    "            else if (a === 'skip') kag.setSkip(!kag.stat.is_skip);",
    "            else if (a === 'hide') {",
    "              if (kag.stat.is_hide_message) kag.layer.showMessageLayers();",
    "              else kag.layer.hideMessageLayers();",
    "            }",
